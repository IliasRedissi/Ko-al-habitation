$.fn.mdlselect = function(options){
  ...
  if (options.value.length == options.label.length && options.value.length > 0){
    theHTML =
      ...
      '</button>' +
      '<ul id="mdl-mdlselect-list-' + field[0].id +'" class="mdl-menu mdl-menu--bottom-right mdl-js-menu mdl-js-ripple-effect mdl-select" for="mdl_select_options_' + field[0].id +'" style="width:100%; padding:1em;">';
